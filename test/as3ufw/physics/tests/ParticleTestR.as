package as3ufw.physics.tests {
	 ...
	 */
	public class ParticleTestR extends ParticleTestBase {
		...
		override public function onEnterFrame(event : Event) : void {
			...
			var delta : Vector2D = perpParticles[5].pos.minus(perpParticles[5].prevPos);
			filter.angle = (delta.angle * 180 / Math.PI) + 200;
			renderContext.filters = [filter];
			engine.update();
			if (lmb)
