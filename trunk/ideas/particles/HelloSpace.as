// forked from hacker_akyifj_9's forked from: forked from: キラキラ3D Typography
// forked from hacker_akyifj_9's forked from: キラキラ3D Typography
// forked from nitoyon's キラキラ3D Typography
// キラキラ3D Typography
//-----------------------------------------------------
// 次の２つの組み合わせ＋αです
//  - HelloWorld3D 
...
package {
    ...
    public class HelloSpace extends Sprite{
        ...
        public function HelloSpace()
        {
            ...
            var bmd:BitmapData = createBitmapData("Richard Jewson 1234567890787879797979");
            initParticles(bmd);
